...
const SocialShareButtons = ({ url, title, description = '', className = '' }: SocialShareButtonsProps) => {
  ...
  return (
    <div className={`flex items-center gap-2 mt-4 ${className}`}>
      <span className="text-sm font-medium text-gray-500">Shpërndaj:</span>
      <div className="flex gap-2">
        ...
        >
          <svg className="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
            <path d="M22 4H2C.9 4 0 4.9 0 6v12c0 1.1.9 2 2 2h20c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-10 7L2 8V6l10 7 10-7v2z" />
          </svg>
        </a>
        <button
