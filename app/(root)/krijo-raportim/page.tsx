...
const page = async () => {
  ...
  return (
    ...
    <div className="w-full max-w-6xl mx-auto py-10 px-4 sm:px-6 lg:px-8 text-center shadow-xl relative">
      <Link href={"/shto-kompani"} className="top-0 absolute right-0 flex flex-row items-center gap-1 shadow-lg p-2 bg-gray-100 hover:bg-gray-200 transition-colors">
        Shto kompani
