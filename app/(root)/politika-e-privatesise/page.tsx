    ...
    <div>
      <main className="flex-1">
        ...
        <div className="max-w-6xl mx-auto py-6">
          ...
          <p className="font-light">Mblidhen vetëm të dhënat që përdoruesi ofron vetë gjatë paraqitjes së një ankese: përshkrimi, dokumente, foto, audio/video ose të dhëna kontakti nëse jepen me dëshirë.</p>
